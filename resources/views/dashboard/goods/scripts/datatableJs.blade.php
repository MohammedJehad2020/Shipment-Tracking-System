<script>
    var KTDatatablesServerSide = function () {
            ...
            dt = $("#datatable").DataTable({
                ...
                columns: [
                  { data: 'checkboxes', name: 'checkboxes', orderable: false, searchable: false },
                    { data: 'name' },
                    { data: 'price_from_city_to_city' },
                    { data: 'price_inside_city' },
                    { data: 'price_country_to_country' },
                    { data: 'created_at' },
                    { data: 'status' },
        ...
        var handleSearchDatatable = function () {
            const filterSearch = document.querySelector('[data-kt-goods-table-filter="search"]');
