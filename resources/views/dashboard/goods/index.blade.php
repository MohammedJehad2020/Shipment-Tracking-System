<x-master>
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-goods-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search goods" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <!--end::Export-->
                    <!--begin::Add user-->
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_goods">
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bolder">{{ t('Export Goods') }}</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
        ...
        <div class="card-body py-4">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="datatable" {{-- id="kt_table_users" --}}>
                <thead>
                    <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">{{ t('Price From City To City') }}</th>
                        <th class="min-w-125px">{{ t('Price Inside City') }}</th>
                        <th class="min-w-125px">{{ t('Price Country To Country') }}</th>
...
@include('dashboard.goods.scripts.datatableJs')
@include('dashboard.includes.delete_item',['route_delete'=>url("/goods")])
@include('dashboard.includes.delete_array', ['route_delete' => route('goods.del_ids')])
