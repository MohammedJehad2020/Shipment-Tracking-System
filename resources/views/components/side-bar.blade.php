            ...
            <div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-icon-gray-400 menu-arrow-gray-400 fw-bold fs-6 my-auto" data-kt-menu="true">
                <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item here show py-3">
                    ...
                    <div class="menu-sub menu-sub-dropdown w-225px w-lg-275px px-1 py-4">
                        <div class="menu-item">
                            <a class="menu-link active" href="{{ route('master') }}">
                    ...
                    <div class="menu-sub menu-sub-dropdown w-225px w-lg-275px px-1 py-4">
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            <span class="menu-link">
                                ...
                                <span class="menu-title">{{ t('Shipments Management') }}</span>
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('shipments.index') }}">
                                        ...
                                        <span class="menu-title">{{ t('Shipments List') }}</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link" href="{{ route('goods.index') }}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">{{ t('Goods List') }}</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        <div class="menu-item">
                                            <a class="menu-link" href="{{ route('permissions.index') }}">
                                                ...
                                                <span class="menu-title">{{ t('Permissions List') }}</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
